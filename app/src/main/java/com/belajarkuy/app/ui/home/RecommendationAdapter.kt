...
class RecommendationAdapter(
...
) : RecyclerView.Adapter<RecommendationAdapter.ModuleViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ModuleViewHolder =
        ModuleViewHolder(ItemRecommendationBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    ...
    inner class ModuleViewHolder(private val binding: ItemRecommendationBinding) :
